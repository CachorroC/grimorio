...
interface AccordionScrollContextType {
  ...
  handleAccordionChange: ( panelId: string, cardId: string ) => ( event: SyntheticEvent, isExpanded: boolean ) => void;
...
export const AccordionScrollProvider = (
  ...
  return (
    <AccordionScrollContext.Provider value={{
      expanded,
