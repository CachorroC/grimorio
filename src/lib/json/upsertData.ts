...
import { EspecimenType,
  ...
  TridoshasType, } from '../types/especimenTypes';
      ...
      (
        ...
        // --- SAFE MERGE LOGIC ---
          ...
          const mergedDoc: EspecimenType = {
            ...
            elementosAsociados: existing.elementosAsociados || incoming.elementosAsociados,
...
export async function executeUpsert() {
  ...
  try {
    ...
    const dataEntrante = [] as EspecimenType[];//arrayedMapPlantList
