...
const plantList: EspecimenType[][] = [
  ...
  [
    {
      ...
      correspondenciasEnergeticas: [
        ...
        'Uso en rituales de nacimiento y unión comunitaria',
        'Guardian del agua',
        'Purificador de la energia vital',
      ],
      imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/7/7b/Frailejon_Espeletia_sp..JPG',
      malesEmocionales: [
        'Mal de ojo',
        'Malas intenciones',
      ...
      propiedadesMedicinales: [
        'Monoterpenos (especialmente alpha-pineno)',
        'Sesquiterpenos',
        'Antifúngico',
        'Antimicrobiano',
        'Cicatrizantes',
      ...
      preparaciones: [
        {
          usoTerapeutico:
            'Sahumerio de resina para la limpieza espiritual. tambien sirve para limpiar un espacio',
          formaDeAplicacion:
            'Encender y pasar el humo alrededor de la persona o por los rincones del hogar.',
          ingredientes: [
            {
              ingrediente:
                'Hojas secas de frailejon. las que están de color café y crujientes en la base',
              cantidad: 'un puñado',
            },
            {
            ...
            {
              ingrediente:
                'resina de copal o granos de incienso natural para potenciar el aroma',
              cantidad: 'opcional',
            },
            {
          ...
          pasos: [
            [
              1,
              'enciende el carbón en un cuenco de barro o piedra hasta que esté al rojo vivo',
            ],
            [
              2,
        ...
        {
          usoTerapeutico:
            'El baño de paramo cura el susto y frio del alma y el enfriamiento articular',
          formaDeAplicacion:
            'Vierte la preparación desde los hombros hacia abajo después de un baño normal y deja secar al aire.',
          ingredientes: [
            {
          ...
          pasos: [
            ...
            [
              4,
              'Después de un baño normal, vierte esta preparación desde los hombros hacia abajo. nunca en la cabeza para rituales de este tipo. No te seques con toalla. deja que el agua se evapore en tu piel para que la esencia de la planta te abrace',
            ],
          ],
        },
      ],
    },
    {
      ...
      malesEmocionales: [
        ...
        'falta de firmeza de caracter',
        'falta de capacidad para resistir la adversidad',
        'Desánimo crónico',
        'Falta de voluntad',
    ...
    },
    {
      ...
      preparaciones: [
        {
          usoTerapeutico: 'Decoccion de achiote',
          formaDeAplicacion:
            'Lavar la zona afectada con la decocción o beber media taza según el uso.',
          ingredientes: [
            {
    ...
    },
    {
      ...
      imageUrl:
        'https://inaturalist-open-data.s3.amazonaws.com/photos/2521480/large.jpg',
      nombresComunes: [
        'Guaba',
        'Jaboncillo',
      ...
      preparaciones: [
        {
          ...
          ingredientes: [
            {
              ingrediente:
                'Hojas limpias de mano de oso (preferiblemente secas)',
              cantidad: '10 gramos',
            },
            {
              ingrediente: 'Agua',
  ...
  [
      ...
      preparaciones: [
        {
          ...
          ingredientes: [
            ...
            {
              ingrediente:
                'Agua hirviendo (para hojas) o agua fría (para jugo)',
              cantidad: '250 ml',
            },
          ],
          pasos: [
    ...
    },
    {
      ...
      imageUrl:
        'https://plantasdecolombia.com/wp-content/uploads/2014/11/img_1812.jpg',
      nombresComunes: [
        'Espino',
      ...
      preparaciones: [
        {
          ...
          formaDeAplicacion:
            'Tomar 1 taza de decocción caliente 2 veces al día.',
          ingredientes: [
            {
      ...
      preparaciones: [
        {
          ...
          formaDeAplicacion:
            'Beber la infusión colada después de las comidas principales.',
          ingredientes: [
            {
        ...
        },
        {
          ...
          formaDeAplicacion:
            'Consumir en gotas (si es aceite de grado alimenticio) o frotar sobre el área hepática externamente.',
          ingredientes: [
            {
