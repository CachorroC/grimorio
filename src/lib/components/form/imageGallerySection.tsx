...
export default function ImageGallerySection({ includeImagenes, onToggleInclude, imagenes, onChange }: ImageGallerySectionProps) {
  const currentImagenes = imagenes || {
    flor: { src: '', alt: '' },
    hojas: { src: '', alt: '' },
  };

  const handleImagenChange = (plantKey: keyof PlantDictionary, field: 'src' | 'alt', value: string) => {
    onChange({
      ...currentImagenes,
      [plantKey]: {
        ...(currentImagenes[plantKey] || { src: '', alt: '' }),
        [field]: value,
      },
    });
  };
  ...
  return (
    <div className={styles.section}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
        <h3 className={styles.sectionSubTitle} style={{ margin: 0 }}>
      ...
      {includeImagenes && (
        <>
          <div className={styles.subSection} style={{ marginBottom: '1rem' }}>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('flor', 'src', e.target.value)}
              ...
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('flor', 'alt', e.target.value)}
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('hojas', 'src', e.target.value)}
              ...
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('hojas', 'alt', e.target.value)}
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('semillas', 'src', e.target.value)}
              ...
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('semillas', 'alt', e.target.value)}
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('tallo', 'src', e.target.value)}
              ...
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('tallo', 'alt', e.target.value)}
                  placeholder="Opcional"
                />
              </div>
            </div>
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('preparacion', 'src', e.target.value)}
                  placeholder="Opcional"
                />
              </div>
              <div className={styles.inputGroup} style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => handleImagenChange('preparacion', 'alt', e.target.value)}
                  placeholder="Opcional"
                />
              </div>
            </div>
